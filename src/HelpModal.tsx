    ...
    <Dialog.Portal>
      ...
      >
        <div className="modal-header">
          <Dialog.Title>
            jiffy — review diffs while your agent works
          </Dialog.Title>
          <Dialog.Close className="ghost">✕</Dialog.Close>
        </div>
        <Dialog.Description>
          <section>
            <h3>Views</h3>
            <ul>
              <li>
                ...
                that bookmark's whole diff (its PR), or a single change for just
                that revision.
              </li>
              <li>
                The <b>working copy</b> segment is everything since the nearest
                bookmark, including unsaved file edits — "what the agent has
                done since I last marked a checkpoint".
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul>
              ...
              <li>
                ...
                another modal is open, a context menu is open, or focus is
                inside text input.
              </li>
              <li>
